...
const DICTIONARY: Record<TCertificateModel, string> = {
    ...
    certificateApplicant__id: "certificateApplicant__id",
    certificate_id: "certificate_id",
    certificate_link: "certificate_link",
    certificate_name: "certificate_name",
    certificate_status: "certificate_status",
    certificateTestinglab__id: "certificateTestinglab__id",
    certificationAuthority__id: "certificationAuthority__id",
