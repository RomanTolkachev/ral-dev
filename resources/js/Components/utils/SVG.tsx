...
export const SVG: FunctionComponent<IProps> = ({
    ...
    if (!arrow && !notFound && !sun && !moon && !magnifyingGlass && !schedule && !alert && !escape && !navArrow && !navDoubleArrow && !home && !burger && !gear) {
        return null
    }
    return (
        <>
            ...
            {burger && (
                <svg width="100%" height="100%" className={`${className}`} viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 12H18V10H0V12ZM0 7H18V5H0V7ZM0 0V2H18V0H0Z" fill="#898989" />
                </svg>
            )}
            {gear && (
