...
export default {
    ...
    safeList: ['rotate-180', 'list-disc', 'rotate-0', 'checkbox-custom', 'thumb-secondary', 'text-wrap', 'filter-dropdown-button-active', "pl-8", "text-gray-400", 'w-12', 'line-clamp-3', 'text-start'],
    theme: {
        extend: {
            fontFamily: {
